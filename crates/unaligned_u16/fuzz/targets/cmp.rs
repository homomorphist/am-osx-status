...
fuzz_target!(|v: (&str, &str)| {
    ...
    let ll = Utf16Str::<SystemEndian>::new(u16_slice_as_u8_slice(&l_u16_bytes)).expect("couldn't convert left");
    let rr = Utf16Str::<SystemEndian>::new(u16_slice_as_u8_slice(&r_u16_bytes)).expect("couldn't convert right");

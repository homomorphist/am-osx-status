...
#[derive(Debug)]
pub struct OutputExtractionFailure;
impl core::error::Error for OutputExtractionFailure {}
impl core::fmt::Display for OutputExtractionFailure {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str("unable to extract output")
    }
}
